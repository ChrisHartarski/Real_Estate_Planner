...
public class CommentServiceImplUnitTests {
    ...
    private static final AddCommentDTO TEST_ADD_COMMENT_DTO = new AddCommentDTO("comment_text", TEST_USER.getFirstName(), TEST_USER.getLastName(), TEST_APARTMENT);
    ...
    public void testAddComment_addsCommentCorrectly() {
        ...
        Assertions.assertEquals(TEST_ADD_COMMENT_DTO.getUserFirstName(), actual.getUserFirstName());
        Assertions.assertEquals(TEST_ADD_COMMENT_DTO.getUserLastName(), actual.getUserLastName());
